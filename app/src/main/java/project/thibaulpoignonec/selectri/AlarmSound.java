...
Cette classe permet de faire sonner l'alarme du téléphone quand est venu le temps de sortir la poubelle jaune ;)
...
public class AlarmSound extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sortir_jaune);
//Gestion du bouton stop
        Button stop1 = (Button) findViewById(R.id.stop1);
        stop1.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View arg0, MotionEvent arg1) {
                player.stop();
                AlarmSound.this.finish();
                return false;
            }
        });
